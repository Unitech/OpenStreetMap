...
class SpotsControllerTest < ActionController::TestCase
  ...
  test "should create spot" do
    assert_difference('Spot.count') do
      post :create, spot: { content: @spot.content, lat: @spot.lat, lng: @spot.lng, spot_type: @spot.spot_type }
    end
  ...
  test "should update spot" do
    put :update, id: @spot, spot: { content: @spot.content, lat: @spot.lat, lng: @spot.lng, spot_type: @spot.spot_type }
    assert_redirected_to spot_path(assigns(:spot))
  end
